...
var FormDescription = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)("p", __assign({ ref: ref, id: formDescriptionId, className: (0, utils_1.cn)("text-[0.8rem] text-muted-foreground", className) }, props)));
});
...
var FormMessage = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)("p", __assign({ ref: ref, id: formMessageId, className: (0, utils_1.cn)("text-[0.8rem] font-medium text-destructive", className) }, props, { children: body })));
});
